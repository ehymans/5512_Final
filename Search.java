...
*******************************************************************************/
	...
	// Set up Standard Deviation array. 
		stdArr = new double[Parameters.generations];
		for(int i=0; i < Parameters.generations; i++){
			stdArr[i] = 0;
		}
	...
	//	Initialize RNG, array sizes and other objects
		...
		for (R = 1; R <= Parameters.numRuns; R++){
			...
			for (G=0; G<Parameters.generations; G++){
				...
				stdArr[G] = (stdArr[G] + stdevRawFitness);
		...
		summaryOutput.write("Gen                AvgFit              BestFit			  AvgStd \n");
		for (int i=0; i<Parameters.generations; i++){
			...
			Hwrite.left(stdArr[i]/Parameters.numRuns, 20, 2, summaryOutput);
			summaryOutput.write("\n");
		}

		for (int i=0; i<Parameters.generations; i++){
			System.out.print(i +"\t\t");
			System.out.print(fitnessStats[0][i]/Parameters.numRuns+"\t\t");
			System.out.print(fitnessStats[1][i]/Parameters.numRuns+"\t\t");
			System.out.print(stdArr[i]/Parameters.numRuns+"\t\t");
			System.out.println();
		}
		System.out.println(bestOverAllChromo.proFitness);
		summaryOutput.write("\n");
		summaryOutput.close();
		...
		// 	System.out.println(bestOverAllChromo.chromo.get(i).x + " "+ bestOverAllChromo.chromo.get(i).y);
		// }
